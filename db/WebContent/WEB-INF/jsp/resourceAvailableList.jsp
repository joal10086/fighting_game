...
<div> 
		<div>Payment List</div>
			...
			<form action="Report_resourceAvailableList.shtml" namespace="/" name="searchForm" id="searchForm">
			...
			<table width="100%" border="0" cellspacing="10" cellpadding="50" class="table-main" >
				...
				<tr   style="background-color: #FFE7A5; cursor: pointer;" >
					...
					<td align="left" width="140" valign="middle"><c:out value="${infor.description}"/></td>
					 <td align="left" width="100" valign="middle"><c:out value="${infor.dname}"/></td>  
					 <td align="left" width="100" valign="middle"><c:out value="${infor.dif}"/></td>
