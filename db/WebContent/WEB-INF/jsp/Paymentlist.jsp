...
<div> 
		<div>Payment List</div>
			...
			<form action="Payment_getPaymentList.shtml?pageSize=50&currentPage=1" namespace="/" name="searchForm" id="searchForm">
				<input type="text" name="pay_text" id="pay_text" >
				<select name="pay_type" id="pay_type">
       			 <option value="0" selected="selected">first name</option>
			...
			<table width="100%" border="0" cellspacing="10" cellpadding="50" class="table-main" >
				...
				<tr   style="background-color: #FFE7A5; cursor: pointer;" >
					...
					<td align="left" width="150" valign="middle"> <c:out value="${infor.pf}，${infor.pl}"/></td> 						
					<%-- <td align="left" width="100" valign="middle"><c:out value="${infor.dname}"/></td> --%>
					<td align="left" width="140" valign="middle"><c:out value="${infor.iname}"/></td>
					<td align="left" width="140" valign="middle"><c:out value="${infor.createtime}"/></td>
					<td align="left" width="100" valign="middle"><c:out value="${infor.remark}"/></td>
					<%-- <td align="left" width="130" valign="middle"><c:out value="${infor.udeadline}"/></td> --%>
			 
					<td align="left" valign="middle"  >
						<a class="showDetail" href="Trans_add.do?trans_mid=${infor.pay_id}">
						<input type="button" value="Return" class="modifyBtn" buttonId="${infor.pay_id}" id="modifyBtn">
						</a>
					</td>					
				</tr>
				</c:forEach>                   
