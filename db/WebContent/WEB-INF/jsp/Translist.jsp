...
<div> 
		<div>Transaction List</div>
			...
			<form action="Trans_getUseList.shtml?pageSize=50&currentPage=1" namespace="/" name="searchForm" id="searchForm">
				<input type="text" name="use_text" id="use_text" >
			...
			<table width="100%" border="0" cellspacing="10" cellpadding="50" class="table-main" >
				...
				<tr   style="background-color: #FFE7A5; cursor: pointer;" >
					...
					<td align="left" width="100" valign="middle"><c:out value="${infor.iname}"/></td>
					<td align="left" width="140" valign="middle"><c:out value="${infor.dname}"/></td>
					<td align="left" width="140" valign="middle"><c:out value="${infor.creattime}"/></td>
				...
				<%-- 	<td align="left" width="60" valign="middle">	
					...
					<td align="left" valign="middle"  >
						<a class="showDetail" href="Trans_add.do?trans_mid=${infor.use_id}">
						<input type="button" value="Return" class="modifyBtn" buttonId="${infor.use_id}" id="modifyBtn">
						</a>
					</td>					
				</tr>
				</c:forEach>                   
