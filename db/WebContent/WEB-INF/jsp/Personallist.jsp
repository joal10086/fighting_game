...
<s:form action="p_changeFlag" namespace="/" theme="simple" name="setInforForm" id="setInforForm">
		<s:hidden name="updateId" id="updateId" ></s:hidden>
		<s:hidden name="updateflag" id="updateflag" ></s:hidden>
</s:form>
<s:form action="p_delete" namespace="/" name="deleteForm" id="deleteForm" theme="simple" >
		<s:hidden name="deleteid" id="deleteid"></s:hidden>
</s:form>
<div> 
		<div>Personal List</div>
 
			<form action="p_getList.shtml" namespace="/" name="searchForm" id="searchForm">
				<input type="text" name="p_loginname" id="p_loginname" >
			...
			<table width="100%" border="0" cellspacing="10" cellpadding="50" class="table-main" >
				...
				<tr   style="background-color: #FFE7A5; cursor: pointer;" >
					...
					<td align="left" width="150" valign="middle"> <c:out value="${infor.loginname}"/></td> 						
					<td align="left" width="200" valign="middle"><c:out value="${infor.role}"/></td>
					...
					<%-- <c:if test="${infor.flag=='1'}"> --%>
						<input type="button" value="delete"  class="updateButton" newflag="0" buttonId="${infor.emp_id}" />
					<%-- </c:if>	 --%>
					</td>
					<td align="left" valign="middle"  >
						<a class="showDetail" href="p_add.do?pid=${infor.emp_id}">
						<input type="button" value="modify" class="modifyBtn" buttonId="${infor.emp_id}" id="modifyBtn">
						</a>
					</td>					
				</tr>
				</c:forEach>                   
