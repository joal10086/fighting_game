...
<s:form action="Dept_changeFlag" namespace="/" theme="simple" name="setInforForm" id="setInforForm">
...
<div> 
		<div>Department List</div>
			...
			<form action="Dept_getList.shtml" namespace="/" name="searchForm" id="searchForm">
				<input type="text" name="dept_text" id="dept_text" >
			...
			<table width="100%" border="0" cellspacing="10" cellpadding="50" class="table-main" >
				<tr class="">	
					...
					<td align="left" width="320" valign="middle">
						location
					</td>
				...
				<tr   style="background-color: #FFE7A5; cursor: pointer;" >
					...
					<td align="left" width="150" valign="middle"> <c:out value="${infor.name}"/></td> 						
					<td align="left" width="300" valign="middle"><c:out value="${infor.location}"/></td>
					...
					<td align="left" valign="middle"  >
						<a class="showDetail" href="Dept_add.do?dept_mid=${infor.dept_id}">
